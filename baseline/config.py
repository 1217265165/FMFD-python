...
K_LIST = [3.5] if SINGLE_BAND_MODE else [3, 4]  # 单频段使用单一包络系数
...
BASELINE_OFFSETS = f"{OUTPUT_DIR}/baseline_offsets.csv"
BASELINE_RESIDUAL_STATS = f"{OUTPUT_DIR}/baseline_residual_stats.json"
NORMAL_STATS_JSON = f"{OUTPUT_DIR}/normal_stats.json"
NORMAL_STATS_NPZ = f"{OUTPUT_DIR}/normal_stats.npz"
